...
public class WeaponDefinition{
    ...
    [Tooltip("Prefab of object attached to ship")]
    public GameObject weaponModelPrefab;
    [Tooltip("Prefab of projectile that gets fired")]
    public GameObject projectilePrefab;
    [Tooltip("Color of fired projectile")]
    public Color projectileColor = Color.white;
    [Tooltip("Damaged Caused when a projectile hits an enemy")]
    public float damageOnHit = 0;
    [Tooltip("Damage caused by laser weapon [not implemented]")]
